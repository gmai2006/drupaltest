...
const columns = [
  ...
  { name: 'rolesTargetId', header: 'rolesTargetId', defaultFlex: 1 },
]

const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'lafoluserroles/selectAll',{
    headers : {
