...
const columns = [
  ...
  { name: 'commentStatus', header: 'commentStatus', defaultFlex: 1 },
]

const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'lafolnoderevisioncomment/selectAll',{
    headers : {
...
const LafOlNodeRevisionComment = () => {
...
export default LafOlNodeRevisionComment;