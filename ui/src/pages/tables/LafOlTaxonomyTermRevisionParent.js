...
const columns = [
  ...
  { name: 'parentTargetId', header: 'parentTargetId', defaultFlex: 1 },
]

const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'lafoltaxonomytermrevisionparent/selectAll',{
    headers : {
...
const LafOlTaxonomyTermRevisionParent = () => {
...
export default LafOlTaxonomyTermRevisionParent;