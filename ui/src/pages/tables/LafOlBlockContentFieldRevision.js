...
const loadData = () => {
  return fetch('/' + init.appName + '/rest/'  + 'lafolblockcontentfieldrevision/selectAll',{
    headers : {
...
const LafOlBlockContentFieldRevision = () => {
...
export default LafOlBlockContentFieldRevision;