...
public class JsonParserTest {
    ...
    public void testParsingLafOlBatch() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals bid ", o.get("bid").getAsInt(), result.get(i).getBid(), 0.0001);
            assertEquals(
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals batch ", o.get("batch").getAsString(), result.get(i).getBatch());
        }
    ...
    public void testParsingLafOlBlockContent() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals uuid ", o.get("uuid").getAsString(), result.get(i).getUuid());
            assertEquals(
            ...
            assertEquals(
                    "expect equals langcode ",
                    o.get("langcode").getAsString(),
                    result.get(i).getLangcode());
        }
    ...
    public void testParsingLafOlBlockContentBody() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals delta ",
                    o.get("delta").getAsInt(),
                    result.get(i).getDelta(),
                    0.0001);
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals bundle ",
                    o.get("bundle").getAsString(),
                    result.get(i).getBundle());
            assertEquals(
                    "expect equals revisionId ",
                    o.get("revisionId").getAsInt(),
                    result.get(i).getRevisionId(),
    ...
    public void testParsingLafOlBlockContentFieldData() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals info ", o.get("info").getAsString(), result.get(i).getInfo());
            assertEquals(
    ...
    public void testParsingLafOlCacheBootstrap() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals expire ",
                    o.get("expire").getAsInt(),
                    result.get(i).getExpire(),
                    0.0001);
            assertEquals(
                    "expect equals created ",
                    o.get("created").getAsBigDecimal(),
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals tags ", o.get("tags").getAsString(), result.get(i).getTags());
            assertEquals(
                    "expect equals checksum ",
                    o.get("checksum").getAsString(),
                    result.get(i).getChecksum());
        }
    ...
    public void testParsingLafOlComment() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals uuid ", o.get("uuid").getAsString(), result.get(i).getUuid());
            assertEquals(
                    "expect equals cid ", o.get("cid").getAsInt(), result.get(i).getCid(), 0.0001);
            assertEquals(
    ...
    public void testParsingLafOlCommentFieldData() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals uid ", o.get("uid").getAsInt(), result.get(i).getUid(), 0.0001);
            assertEquals(
                    "expect equals pid ", o.get("pid").getAsInt(), result.get(i).getPid(), 0.0001);
            assertEquals(
                    "expect equals entityId ",
                    o.get("entityId").getAsInt(),
                    result.get(i).getEntityId(),
                    0.0001);
            assertEquals(
                    "expect equals subject ",
                    o.get("subject").getAsString(),
                    result.get(i).getSubject());
            assertEquals(
                    "expect equals name ", o.get("name").getAsString(), result.get(i).getName());
            assertEquals(
                    "expect equals mail ", o.get("mail").getAsString(), result.get(i).getMail());
            assertEquals(
                    "expect equals homepage ",
                    o.get("homepage").getAsString(),
                    result.get(i).getHomepage());
            assertEquals(
                    "expect equals hostname ",
                    o.get("hostname").getAsString(),
                    result.get(i).getHostname());
            assertEquals(
                    "expect equals created ",
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals thread ",
                    o.get("thread").getAsString(),
                    result.get(i).getThread());
            assertEquals(
                    "expect equals entityType ",
                    o.get("entityType").getAsString(),
                    result.get(i).getEntityType());
    ...
    public void testParsingLafOlFileManaged() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            JsonObject o = arr.get(i).getAsJsonObject();
            assertEquals(
                    "expect equals fid ", o.get("fid").getAsInt(), result.get(i).getFid(), 0.0001);
            assertEquals(
                    "expect equals uuid ", o.get("uuid").getAsString(), result.get(i).getUuid());
            assertEquals(
                    "expect equals langcode ",
            ...
            assertEquals(
                    "expect equals filemime ",
                    o.get("filemime").getAsString(),
                    result.get(i).getFilemime());
            assertEquals(
                    "expect equals status ",
                    o.get("status").getAsInt(),
                    result.get(i).getStatus(),
    ...
    public void testParsingLafOlFileUsage() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals fid ", o.get("fid").getAsInt(), result.get(i).getFid(), 0.0001);
            assertEquals(
                    "expect equals module ",
                    o.get("module").getAsString(),
                    result.get(i).getModule());
    ...
    public void testParsingLafOlHistory() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals uid ", o.get("uid").getAsInt(), result.get(i).getUid(), 0.0001);
            assertEquals(
                    "expect equals nid ", o.get("nid").getAsInt(), result.get(i).getNid(), 0.0001);
            assertEquals(
                    "expect equals timestamp ",
                    o.get("timestamp").getAsInt(),
                    result.get(i).getTimestamp(),
    ...
    public void testParsingLafOlLocaleFile() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getLangcode());
            assertEquals(
                    "expect equals project ",
                    o.get("project").getAsString(),
                    result.get(i).getProject());
            assertEquals(
                    "expect equals filename ",
                    o.get("filename").getAsString(),
                    result.get(i).getFilename());
    ...
    public void testParsingLafOlLocalesLocation() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            JsonObject o = arr.get(i).getAsJsonObject();
            assertEquals(
                    "expect equals lid ", o.get("lid").getAsInt(), result.get(i).getLid(), 0.0001);
            assertEquals(
                    "expect equals sid ", o.get("sid").getAsInt(), result.get(i).getSid(), 0.0001);
            assertEquals(
                    "expect equals type ", o.get("type").getAsString(), result.get(i).getType());
            assertEquals(
                    "expect equals name ", o.get("name").getAsString(), result.get(i).getName());
    ...
    public void testParsingLafOlMenuLinkContentData() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals menuName ",
                    o.get("menuName").getAsString(),
                    result.get(i).getMenuName());
            assertEquals(
                    "expect equals linkUri ",
                    o.get("linkUri").getAsString(),
                    result.get(i).getLinkUri());
            assertEquals(
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals parent ",
                    o.get("parent").getAsString(),
                    result.get(i).getParent());
            assertEquals(
                    "expect equals changed ",
                    o.get("changed").getAsInt(),
                    result.get(i).getChanged(),
    ...
    public void testParsingLafOlMenuTree() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getDescription());
            assertEquals(
                    "expect equals class1 ",
                    o.get("class1").getAsString(),
                    result.get(i).getClass1());
            assertEquals(
                    "expect equals options ",
                    o.get("options").getAsString(),
                    result.get(i).getOptions());
            assertEquals(
                    "expect equals provider ",
                    o.get("provider").getAsString(),
                    result.get(i).getProvider());
            assertEquals(
                    "expect equals enabled ",
                    o.get("enabled").getAsInt(),
                    result.get(i).getEnabled(),
            ...
            assertEquals(
                    ...
                    o.get("metadata").getAsString(),
                    result.get(i).getMetadata());
            assertEquals(
            ...
            assertEquals(
                    "expect equals depth ",
                    o.get("depth").getAsInt(),
                    result.get(i).getDepth(),
                    0.0001);
            assertEquals(
                    "expect equals p1 ", o.get("p1").getAsInt(), result.get(i).getP1(), 0.0001);
            assertEquals(
                    "expect equals p2 ", o.get("p2").getAsInt(), result.get(i).getP2(), 0.0001);
            assertEquals(
                    "expect equals p3 ", o.get("p3").getAsInt(), result.get(i).getP3(), 0.0001);
            assertEquals(
                    "expect equals p4 ", o.get("p4").getAsInt(), result.get(i).getP4(), 0.0001);
            assertEquals(
                    "expect equals p5 ", o.get("p5").getAsInt(), result.get(i).getP5(), 0.0001);
            assertEquals(
                    "expect equals p6 ", o.get("p6").getAsInt(), result.get(i).getP6(), 0.0001);
            assertEquals(
                    "expect equals p7 ", o.get("p7").getAsInt(), result.get(i).getP7(), 0.0001);
            assertEquals(
                    "expect equals p8 ", o.get("p8").getAsInt(), result.get(i).getP8(), 0.0001);
            assertEquals(
                    "expect equals p9 ", o.get("p9").getAsInt(), result.get(i).getP9(), 0.0001);
            assertEquals(
    ...
    public void testParsingLafOlNode() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            JsonObject o = arr.get(i).getAsJsonObject();
            assertEquals(
                    "expect equals vid ", o.get("vid").getAsInt(), result.get(i).getVid(), 0.0001);
            assertEquals(
                    "expect equals nid ", o.get("nid").getAsInt(), result.get(i).getNid(), 0.0001);
            assertEquals(
                    "expect equals uuid ", o.get("uuid").getAsString(), result.get(i).getUuid());
    ...
    public void testParsingLafOlNodeAccess() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    result.get(i).getLangcode());
            assertEquals(
                    "expect equals gid ", o.get("gid").getAsInt(), result.get(i).getGid(), 0.0001);
            assertEquals(
                    "expect equals nid ", o.get("nid").getAsInt(), result.get(i).getNid(), 0.0001);
            assertEquals(
                    "expect equals realm ", o.get("realm").getAsString(), result.get(i).getRealm());
            assertEquals(
    ...
    public void testParsingLafOlNodeFieldData() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals sticky ",
                    o.get("sticky").getAsInt(),
                    result.get(i).getSticky(),
                    0.0001);
            assertEquals(
                    "expect equals defaultLangcode ",
                    o.get("defaultLangcode").getAsInt(),
    ...
    public void testParsingLafOlQueue() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            JsonObject o = arr.get(i).getAsJsonObject();
            assertEquals(
                    "expect equals itemId ",
                    o.get("itemId").getAsInt(),
    ...
    public void testParsingLafOlRouter() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals name ", o.get("name").getAsString(), result.get(i).getName());
            assertEquals(
                    "expect equals path ", o.get("path").getAsString(), result.get(i).getPath());
            assertEquals(
                    "expect equals patternOutline ",
                    o.get("patternOutline").getAsString(),
                    result.get(i).getPatternOutline());
            assertEquals(
                    "expect equals fit ", o.get("fit").getAsInt(), result.get(i).getFit(), 0.0001);
            assertEquals(
    ...
    public void testParsingLafOlSearchIndex() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals type ", o.get("type").getAsString(), result.get(i).getType());
            assertEquals(
                    "expect equals word ", o.get("word").getAsString(), result.get(i).getWord());
            assertEquals(
                    "expect equals sid ", o.get("sid").getAsInt(), result.get(i).getSid(), 0.0001);
            assertEquals(
                    "expect equals score ",
                    o.get("score").getAsFloat(),
    ...
    public void testParsingLafOlSessions() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals session ",
                    o.get("session").getAsString(),
                    result.get(i).getSession());
        }
    ...
    public void testParsingLafOlShortcutSetUsers() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals uid ", o.get("uid").getAsInt(), result.get(i).getUid(), 0.0001);
            assertEquals(
                    "expect equals setName ",
                    o.get("setName").getAsString(),
                    result.get(i).getSetName());
        }
    ...
    public void testParsingLafOlTaxonomyIndex() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals nid ", o.get("nid").getAsInt(), result.get(i).getNid(), 0.0001);
            assertEquals(
                    "expect equals tid ", o.get("tid").getAsInt(), result.get(i).getTid(), 0.0001);
            assertEquals(
                    "expect equals status ",
                    o.get("status").getAsInt(),
                    result.get(i).getStatus(),
    ...
    public void testParsingLafOlUsersFieldData() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            ...
            assertEquals(
                    "expect equals pass ", o.get("pass").getAsString(), result.get(i).getPass());
            assertEquals(
                    "expect equals mail ", o.get("mail").getAsString(), result.get(i).getMail());
            assertEquals(
            ...
            assertEquals(
                    ...
                    0.0001);
            assertEquals(
                    "expect equals access ",
                    o.get("access").getAsInt(),
                    result.get(i).getAccess(),
                    0.0001);
            assertEquals(
                    "expect equals login ",
                    o.get("login").getAsInt(),
                    result.get(i).getLogin(),
                    0.0001);
            assertEquals(
                    "expect equals init ", o.get("init").getAsString(), result.get(i).getInit());
            assertEquals(
                    "expect equals defaultLangcode ",
                    o.get("defaultLangcode").getAsInt(),
                    result.get(i).getDefaultLangcode(),
    ...
    public void testParsingLafOlWatchdog() throws IOException {
        ...
        for (int i = 0; i < arr.size(); i++) {
            JsonObject o = arr.get(i).getAsJsonObject();
            assertEquals(
                    "expect equals wid ", o.get("wid").getAsInt(), result.get(i).getWid(), 0.0001);
            assertEquals(
                    "expect equals uid ", o.get("uid").getAsInt(), result.get(i).getUid(), 0.0001);
            assertEquals(
                    "expect equals type ", o.get("type").getAsString(), result.get(i).getType());
