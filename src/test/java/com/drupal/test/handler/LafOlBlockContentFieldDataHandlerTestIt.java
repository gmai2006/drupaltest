...
import com.drupal.test.dao.DefaultLafOlBlockContentFieldDataDao;
...
public class LafOlBlockContentFieldDataHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlBlockContentFieldData.csv");
    ...
    final LafOlBlockContentFieldDataId id =
        new LafOlBlockContentFieldDataId(this.records[0].getLangcode(), this.records[0].getId());
