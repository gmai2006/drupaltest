...
import com.drupal.test.dao.DefaultLafOlCommentCommentBodyDao;
...
public class LafOlCommentCommentBodyHandlerTestIt {
  static final String inputFile = "LafOlCommentCommentBody.json";
  static LafOlCommentCommentBodyHandler handler;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlCommentCommentBody.csv");
    ...
    LafOlCommentCommentBody testResult = jpa.find(LafOlCommentCommentBody.class, id);
    ...
    assertEquals(
        ...
        this.records[0].getCommentBodyValue(),
        testResult.getCommentBodyValue());
    assertEquals(
        "expect equals commentBodyFormat ",
        this.records[0].getCommentBodyFormat(),
