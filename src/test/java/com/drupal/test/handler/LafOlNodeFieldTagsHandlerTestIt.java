...
import com.drupal.test.dao.DefaultLafOlNodeFieldTagsDao;
...
public class LafOlNodeFieldTagsHandlerTestIt {
  static final String inputFile = "LafOlNodeFieldTags.json";
  static LafOlNodeFieldTagsHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private LafOlNodeFieldTags[] records;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlNodeFieldTags.csv");
    final InputStream inputStream = new BufferedInputStream(new FileInputStream(tempFile));
    int count = handler.process(inputStream);
    String json = FileUtils.readFileFromResource2String(inputFile, Charset.defaultCharset());
    records = gson.fromJson(json, LafOlNodeFieldTags[].class);
    assertEquals("match count", count, records.length);
    final LafOlNodeFieldTagsId id =
        new LafOlNodeFieldTagsId(
            this.records[0].getLangcode(),
            this.records[0].getDeleted(),
            this.records[0].getDelta(),
            this.records[0].getEntityId());
    LafOlNodeFieldTags testResult = jpa.find(LafOlNodeFieldTags.class, id);
