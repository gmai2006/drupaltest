...
import com.drupal.test.dao.DefaultLafOlNodeRevisionBodyDao;
...
public class LafOlNodeRevisionBodyHandlerTestIt {
  static final String inputFile = "LafOlNodeRevisionBody.json";
  static LafOlNodeRevisionBodyHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private LafOlNodeRevisionBody[] records;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlNodeRevisionBody.csv");
    ...
    LafOlNodeRevisionBody testResult = jpa.find(LafOlNodeRevisionBody.class, id);
