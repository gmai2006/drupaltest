...
import com.drupal.test.dao.DefaultLafOlUsersDataDao;
...
public class LafOlUsersDataHandlerTestIt {
  static final String inputFile = "LafOlUsersData.json";
  static LafOlUsersDataHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private LafOlUsersData[] records;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlUsersData.csv");
    ...
    final LafOlUsersDataId id =
        new LafOlUsersDataId(
            this.records[0].getUid(), this.records[0].getModule(), this.records[0].getName());
    LafOlUsersData testResult = jpa.find(LafOlUsersData.class, id);
