...
public class LafOlMenuTreeHandlerTestIt {
    ...
    public void testSelect() throws IOException {
        ...
        assertEquals(
                ...
                this.records[0].getRouteName(),
                testResult.getRouteName());
        assertEquals(
        ...
        assertEquals(
                "expect equals options ", this.records[0].getOptions(), testResult.getOptions());
        assertEquals(
        ...
        org.junit.Assert.assertEquals(
                ...
                this.records[0].getDiscovered(),
                testResult.getDiscovered());
        org.junit.Assert.assertEquals(
        ...
        org.junit.Assert.assertEquals(
                "expect equals p1 ", this.records[0].getP1(), testResult.getP1());
        org.junit.Assert.assertEquals(
                "expect equals p2 ", this.records[0].getP2(), testResult.getP2());
        org.junit.Assert.assertEquals(
                "expect equals p3 ", this.records[0].getP3(), testResult.getP3());
        org.junit.Assert.assertEquals(
                "expect equals p4 ", this.records[0].getP4(), testResult.getP4());
        org.junit.Assert.assertEquals(
                "expect equals p5 ", this.records[0].getP5(), testResult.getP5());
        org.junit.Assert.assertEquals(
                "expect equals p6 ", this.records[0].getP6(), testResult.getP6());
        org.junit.Assert.assertEquals(
                "expect equals p7 ", this.records[0].getP7(), testResult.getP7());
        org.junit.Assert.assertEquals(
                "expect equals p8 ", this.records[0].getP8(), testResult.getP8());
        org.junit.Assert.assertEquals(
                "expect equals p9 ", this.records[0].getP9(), testResult.getP9());
        assertEquals(
                "expect equals formClass ",
                this.records[0].getFormClass(),
                testResult.getFormClass());
