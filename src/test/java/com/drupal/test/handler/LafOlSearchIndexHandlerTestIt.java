...
import com.drupal.test.dao.DefaultLafOlSearchIndexDao;
...
public class LafOlSearchIndexHandlerTestIt {
  static final String inputFile = "LafOlSearchIndex.json";
  static LafOlSearchIndexHandler handler;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlSearchIndex.csv");
    ...
    final LafOlSearchIndexId id =
        new LafOlSearchIndexId(
            ...
            this.records[0].getWord(),
            this.records[0].getSid());
    LafOlSearchIndex testResult = jpa.find(LafOlSearchIndex.class, id);
