...
import com.drupal.test.dao.DefaultLafOlShortcutFieldDataDao;
...
public class LafOlShortcutFieldDataHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlShortcutFieldData.csv");
    ...
    final LafOlShortcutFieldDataId id =
        new LafOlShortcutFieldDataId(this.records[0].getLangcode(), this.records[0].getId());
