...
import com.drupal.test.dao.DefaultLafOlUsersFieldDataDao;
...
public class LafOlUsersFieldDataHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlUsersFieldData.csv");
    ...
    final LafOlUsersFieldDataId id =
        new LafOlUsersFieldDataId(
            this.records[0].getUid(), this.records[0].getLangcode(), this.records[0].getName());
