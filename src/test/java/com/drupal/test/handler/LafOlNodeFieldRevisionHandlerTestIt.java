...
import com.drupal.test.dao.DefaultLafOlNodeFieldRevisionDao;
...
public class LafOlNodeFieldRevisionHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlNodeFieldRevision.csv");
    ...
    final LafOlNodeFieldRevisionId id =
        new LafOlNodeFieldRevisionId(this.records[0].getVid(), this.records[0].getLangcode());
