...
import com.drupal.test.dao.DefaultLafOlHistoryDao;
...
public class LafOlHistoryHandlerTestIt {
  static final String inputFile = "LafOlHistory.json";
  static LafOlHistoryHandler handler;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlHistory.csv");
    ...
    final LafOlHistoryId id =
        new LafOlHistoryId(this.records[0].getUid(), this.records[0].getNid());
    LafOlHistory testResult = jpa.find(LafOlHistory.class, id);
