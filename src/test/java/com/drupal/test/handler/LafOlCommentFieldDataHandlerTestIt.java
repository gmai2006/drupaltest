...
import com.drupal.test.dao.DefaultLafOlCommentFieldDataDao;
...
public class LafOlCommentFieldDataHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlCommentFieldData.csv");
    ...
    final LafOlCommentFieldDataId id =
        new LafOlCommentFieldDataId(this.records[0].getLangcode(), this.records[0].getCid());
    ...
    assertEquals("expect equals subject ", this.records[0].getSubject(), testResult.getSubject());
    ...
    assertEquals(
        "expect equals fieldName ", this.records[0].getFieldName(), testResult.getFieldName());
    org.junit.Assert.assertEquals(
