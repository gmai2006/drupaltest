...
import com.drupal.test.dao.DefaultLafOlMenuLinkContentFieldRevisionDao;
...
public class LafOlMenuLinkContentFieldRevisionHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlMenuLinkContentFieldRevision.csv");
