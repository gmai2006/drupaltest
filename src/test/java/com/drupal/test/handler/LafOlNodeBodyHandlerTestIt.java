...
import com.drupal.test.dao.DefaultLafOlNodeBodyDao;
...
public class LafOlNodeBodyHandlerTestIt {
  static final String inputFile = "LafOlNodeBody.json";
  static LafOlNodeBodyHandler handler;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlNodeBody.csv");
    ...
    LafOlNodeBody testResult = jpa.find(LafOlNodeBody.class, id);
