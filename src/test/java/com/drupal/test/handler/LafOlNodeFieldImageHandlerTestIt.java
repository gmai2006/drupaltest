...
import com.drupal.test.dao.DefaultLafOlNodeFieldImageDao;
...
public class LafOlNodeFieldImageHandlerTestIt {
  static final String inputFile = "LafOlNodeFieldImage.json";
  static LafOlNodeFieldImageHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private LafOlNodeFieldImage[] records;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlNodeFieldImage.csv");
    ...
    LafOlNodeFieldImage testResult = jpa.find(LafOlNodeFieldImage.class, id);
