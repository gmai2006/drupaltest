...
import com.drupal.test.dao.DefaultLafOlWatchdogDao;
...
public class LafOlWatchdogHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlWatchdog.csv");
    ...
    assertEquals(
        "expect equals variables ", this.records[0].getVariables(), testResult.getVariables());
    org.junit.Assert.assertEquals(
    ...
    assertEquals("expect equals referer ", this.records[0].getReferer(), testResult.getReferer());
    assertEquals(
