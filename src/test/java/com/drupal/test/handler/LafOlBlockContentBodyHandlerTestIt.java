...
import com.drupal.test.dao.DefaultLafOlBlockContentBodyDao;
...
public class LafOlBlockContentBodyHandlerTestIt {
  static final String inputFile = "LafOlBlockContentBody.json";
  static LafOlBlockContentBodyHandler handler;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlBlockContentBody.csv");
    ...
    LafOlBlockContentBody testResult = jpa.find(LafOlBlockContentBody.class, id);
