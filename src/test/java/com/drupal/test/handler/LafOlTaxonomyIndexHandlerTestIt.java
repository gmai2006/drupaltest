...
import com.drupal.test.dao.DefaultLafOlTaxonomyIndexDao;
...
public class LafOlTaxonomyIndexHandlerTestIt {
  static final String inputFile = "LafOlTaxonomyIndex.json";
  static LafOlTaxonomyIndexHandler handler;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlTaxonomyIndex.csv");
    ...
    final LafOlTaxonomyIndexId id =
        new LafOlTaxonomyIndexId(this.records[0].getNid(), this.records[0].getTid());
    LafOlTaxonomyIndex testResult = jpa.find(LafOlTaxonomyIndex.class, id);
