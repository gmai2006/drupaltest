...
import com.drupal.test.dao.DefaultLafOlBlockContentFieldRevisionDao;
...
public class LafOlBlockContentFieldRevisionHandlerTestIt {
  static final String inputFile = "LafOlBlockContentFieldRevision.json";
  static LafOlBlockContentFieldRevisionHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private LafOlBlockContentFieldRevision[] records;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/LafOlBlockContentFieldRevision.csv");
    ...
    LafOlBlockContentFieldRevision testResult = jpa.find(LafOlBlockContentFieldRevision.class, id);
    org.junit.Assert.assertEquals("expect equals id ", this.records[0].getId(), testResult.getId());
