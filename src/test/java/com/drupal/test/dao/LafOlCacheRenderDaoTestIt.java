...
public class LafOlCacheRenderDaoTestIt {
    static final String inputFile = "LafOlCacheRender.json";
    static LafOlCacheRenderDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlCacheRenderDao(jpa);
    }
    ...
    public void testSelect() {
        LafOlCacheRender testResult = dao.find(records[1].getCid());
