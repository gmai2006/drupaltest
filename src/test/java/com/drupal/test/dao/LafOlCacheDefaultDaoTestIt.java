...
public class LafOlCacheDefaultDaoTestIt {
    static final String inputFile = "LafOlCacheDefault.json";
    static LafOlCacheDefaultDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlCacheDefaultDao(jpa);
    }
    ...
    public void testSelect() {
        LafOlCacheDefault testResult = dao.find(records[1].getCid());
