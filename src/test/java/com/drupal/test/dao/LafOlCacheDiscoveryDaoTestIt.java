...
public class LafOlCacheDiscoveryDaoTestIt {
    static final String inputFile = "LafOlCacheDiscovery.json";
    static LafOlCacheDiscoveryDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlCacheDiscoveryDao(jpa);
    }
    ...
    public void testSelect() {
        LafOlCacheDiscovery testResult = dao.find(records[1].getCid());
