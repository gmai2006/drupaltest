...
public class LafOlCacheContainerDaoTestIt {
    static final String inputFile = "LafOlCacheContainer.json";
    static LafOlCacheContainerDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlCacheContainerDao(jpa);
    }
    ...
    public void testSelect() {
        LafOlCacheContainer testResult = dao.find(records[1].getCid());
