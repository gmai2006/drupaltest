...
public class LafOlCacheMenuDaoTestIt {
    static final String inputFile = "LafOlCacheMenu.json";
    static LafOlCacheMenuDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlCacheMenuDao(jpa);
    }
    ...
    public void testSelect() {
        LafOlCacheMenu testResult = dao.find(records[1].getCid());
