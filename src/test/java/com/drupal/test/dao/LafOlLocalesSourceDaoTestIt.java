...
public class LafOlLocalesSourceDaoTestIt {
    static final String inputFile = "LafOlLocalesSource.json";
    static LafOlLocalesSourceDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlLocalesSourceDao(jpa);
    }
    ...
    public void testSelect() {
        LafOlLocalesSource testResult = dao.find(records[1].getLid());
