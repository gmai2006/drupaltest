...
public class LafOlCacheBootstrapDaoTestIt {
    static final String inputFile = "LafOlCacheBootstrap.json";
    static LafOlCacheBootstrapDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlCacheBootstrapDao(jpa);
    }
    ...
    public void testSelect() {
        LafOlCacheBootstrap testResult = dao.find(records[1].getCid());
