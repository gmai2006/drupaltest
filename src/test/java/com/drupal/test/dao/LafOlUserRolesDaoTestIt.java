...
public class LafOlUserRolesDaoTestIt {
  static final String inputFile = "LafOlUserRoles.json";
  static LafOlUserRolesDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultLafOlUserRolesDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    LafOlUserRoles testResult = dao.find(id);
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[1].getRolesTargetId(),
