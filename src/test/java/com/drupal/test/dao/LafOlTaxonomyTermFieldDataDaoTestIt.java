...
public class LafOlTaxonomyTermFieldDataDaoTestIt {
  static final String inputFile = "LafOlTaxonomyTermFieldData.json";
  static LafOlTaxonomyTermFieldDataDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultLafOlTaxonomyTermFieldDataDao(jpa);
  }
  ...
  public void testSelect() {
    final LafOlTaxonomyTermFieldDataId id =
        new LafOlTaxonomyTermFieldDataId(this.records[1].getLangcode(), this.records[1].getTid());
    LafOlTaxonomyTermFieldData testResult = dao.find(id);
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals revisionId ", this.records[1].getRevisionId() == testResult.getRevisionId());
    org.junit.Assert.assertEquals(
        "expect equals vid ", this.records[1].getVid(), testResult.getVid());
    org.junit.Assert.assertTrue(
