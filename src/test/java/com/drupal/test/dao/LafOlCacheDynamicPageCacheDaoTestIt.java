...
public class LafOlCacheDynamicPageCacheDaoTestIt {
  static final String inputFile = "LafOlCacheDynamicPageCache.json";
  static LafOlCacheDynamicPageCacheDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultLafOlCacheDynamicPageCacheDao(jpa);
  }
  ...
  public void testSelect() {
    LafOlCacheDynamicPageCache testResult = dao.find(records[1].getCid());
