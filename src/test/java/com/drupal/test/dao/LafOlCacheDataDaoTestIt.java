...
public class LafOlCacheDataDaoTestIt {
    static final String inputFile = "LafOlCacheData.json";
    static LafOlCacheDataDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlCacheDataDao(jpa);
    }
    ...
    public void testSelect() {
        LafOlCacheData testResult = dao.find(records[1].getCid());
