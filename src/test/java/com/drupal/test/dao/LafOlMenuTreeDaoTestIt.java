...
public class LafOlMenuTreeDaoTestIt {
    ...
    public void testSelect() {
        ...
        org.junit.Assert.assertTrue(
                ...
                this.records[1].getDiscovered() == testResult.getDiscovered());
        org.junit.Assert.assertTrue(
                "expect equals expanded ",
                this.records[1].getExpanded() == testResult.getExpanded());
        org.junit.Assert.assertTrue(
        ...
        org.junit.Assert.assertTrue(
                "expect equals p1 ", this.records[1].getP1() == testResult.getP1());
        org.junit.Assert.assertTrue(
                "expect equals p2 ", this.records[1].getP2() == testResult.getP2());
        org.junit.Assert.assertTrue(
                "expect equals p3 ", this.records[1].getP3() == testResult.getP3());
        org.junit.Assert.assertTrue(
                "expect equals p4 ", this.records[1].getP4() == testResult.getP4());
        org.junit.Assert.assertTrue(
                "expect equals p5 ", this.records[1].getP5() == testResult.getP5());
        org.junit.Assert.assertTrue(
                "expect equals p6 ", this.records[1].getP6() == testResult.getP6());
        org.junit.Assert.assertTrue(
                "expect equals p7 ", this.records[1].getP7() == testResult.getP7());
        org.junit.Assert.assertTrue(
                "expect equals p8 ", this.records[1].getP8() == testResult.getP8());
        org.junit.Assert.assertTrue(
                "expect equals p9 ", this.records[1].getP9() == testResult.getP9());
        org.junit.Assert.assertEquals(
                "expect equals formClass ",
                this.records[1].getFormClass(),
