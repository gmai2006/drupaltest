...
public class LafOlNodeFieldTagsDaoTestIt {
    static final String inputFile = "LafOlNodeFieldTags.json";
    static LafOlNodeFieldTagsDao dao;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void beforeClass() {
        ...
        dao = new DefaultLafOlNodeFieldTagsDao(jpa);
    }
    ...
    public void testSelect() {
        ...
        LafOlNodeFieldTags testResult = dao.find(id);
