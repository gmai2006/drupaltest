...
public class LafOlFileUsageDaoTestIt {
  static final String inputFile = "LafOlFileUsage.json";
  static LafOlFileUsageDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultLafOlFileUsageDao(jpa);
  }
