...
public class LafOlUserRolesServiceTest {
  private static DefaultLafOlUserRolesService serviceMock;
  private static LafOlUserRoles[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlUserRolesService.class);
    String inputFile = "LafOlUserRoles.json";
    try {
  ...
  public void testFind_success() {
    final LafOlUserRolesId id =
        new LafOlUserRolesId(
            ...
            records[0].getDelta(),
            records[0].getEntityId());
    LafOlUserRoles testResult = serviceMock.find(id);
