...
public class LafOlTaxonomyIndexServiceTest {
    private static DefaultLafOlTaxonomyIndexService serviceMock;
    private static LafOlTaxonomyIndex[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultLafOlTaxonomyIndexService.class);
        String inputFile = "LafOlTaxonomyIndex.json";
        try {
            String json =
        ...
        final LafOlTaxonomyIndexId id =
                new LafOlTaxonomyIndexId(records[0].getNid(), records[0].getTid());
    ...
    public void testFind_success() {
        final LafOlTaxonomyIndexId id =
                new LafOlTaxonomyIndexId(records[0].getNid(), records[0].getTid());
        LafOlTaxonomyIndex testResult = serviceMock.find(id);
