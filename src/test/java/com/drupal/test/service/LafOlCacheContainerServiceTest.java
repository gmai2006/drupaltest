...
public class LafOlCacheContainerServiceTest {
  private static DefaultLafOlCacheContainerService serviceMock;
  private static LafOlCacheContainer[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlCacheContainerService.class);
    String inputFile = "LafOlCacheContainer.json";
    try {
  ...
  public void testFind_success() {
    LafOlCacheContainer testResult = serviceMock.find(records[0].getCid());
