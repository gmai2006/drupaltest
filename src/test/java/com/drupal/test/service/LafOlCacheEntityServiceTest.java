...
public class LafOlCacheEntityServiceTest {
  private static DefaultLafOlCacheEntityService serviceMock;
  private static LafOlCacheEntity[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlCacheEntityService.class);
    String inputFile = "LafOlCacheEntity.json";
    try {
  ...
  public void testFind_success() {
    LafOlCacheEntity testResult = serviceMock.find(records[0].getCid());
