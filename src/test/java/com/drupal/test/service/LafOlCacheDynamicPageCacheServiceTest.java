...
public class LafOlCacheDynamicPageCacheServiceTest {
    private static DefaultLafOlCacheDynamicPageCacheService serviceMock;
    private static LafOlCacheDynamicPageCache[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultLafOlCacheDynamicPageCacheService.class);
        String inputFile = "LafOlCacheDynamicPageCache.json";
        try {
            String json =
    ...
    public void testFind_success() {
        LafOlCacheDynamicPageCache testResult = serviceMock.find(records[0].getCid());
