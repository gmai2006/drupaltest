...
public class LafOlCacheDefaultServiceTest {
    private static DefaultLafOlCacheDefaultService serviceMock;
    private static LafOlCacheDefault[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultLafOlCacheDefaultService.class);
        String inputFile = "LafOlCacheDefault.json";
        try {
            String json =
    ...
    public void testFind_success() {
        LafOlCacheDefault testResult = serviceMock.find(records[0].getCid());
