...
public class LafOlLocaleFileServiceTest {
  private static DefaultLafOlLocaleFileService serviceMock;
  private static LafOlLocaleFile[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlLocaleFileService.class);
    String inputFile = "LafOlLocaleFile.json";
    try {
    ...
    final LafOlLocaleFileId id =
        new LafOlLocaleFileId(records[0].getLangcode(), records[0].getProject());
  ...
  public void testFind_success() {
    final LafOlLocaleFileId id =
        new LafOlLocaleFileId(records[0].getLangcode(), records[0].getProject());
    LafOlLocaleFile testResult = serviceMock.find(id);
    ...
    org.junit.Assert.assertTrue(
        "expect equals lastChecked ", records[0].getLastChecked() == testResult.getLastChecked());
  }
}
