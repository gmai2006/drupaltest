...
public class LafOlNodeFieldDataServiceTest {
  private static DefaultLafOlNodeFieldDataService serviceMock;
  private static LafOlNodeFieldData[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlNodeFieldDataService.class);
    String inputFile = "LafOlNodeFieldData.json";
    try {
    ...
    final LafOlNodeFieldDataId id =
        new LafOlNodeFieldDataId(records[0].getLangcode(), records[0].getNid());
  ...
  public void testFind_success() {
    final LafOlNodeFieldDataId id =
        new LafOlNodeFieldDataId(records[0].getLangcode(), records[0].getNid());
    LafOlNodeFieldData testResult = serviceMock.find(id);
    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertTrue("expect equals vid ", records[0].getVid() == testResult.getVid());
