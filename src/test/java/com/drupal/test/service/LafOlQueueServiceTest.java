...
public class LafOlQueueServiceTest {
  private static DefaultLafOlQueueService serviceMock;
  private static LafOlQueue[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlQueueService.class);
    String inputFile = "LafOlQueue.json";
    try {
  ...
  public void testFind_success() {
    LafOlQueue testResult = serviceMock.find(records[0].getItemId());
