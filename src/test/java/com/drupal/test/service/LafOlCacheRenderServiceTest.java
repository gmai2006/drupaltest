...
public class LafOlCacheRenderServiceTest {
  private static DefaultLafOlCacheRenderService serviceMock;
  private static LafOlCacheRender[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlCacheRenderService.class);
    String inputFile = "LafOlCacheRender.json";
    try {
  ...
  public void testFind_success() {
    LafOlCacheRender testResult = serviceMock.find(records[0].getCid());
