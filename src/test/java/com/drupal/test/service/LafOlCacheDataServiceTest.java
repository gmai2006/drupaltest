...
public class LafOlCacheDataServiceTest {
  private static DefaultLafOlCacheDataService serviceMock;
  private static LafOlCacheData[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlCacheDataService.class);
    String inputFile = "LafOlCacheData.json";
    try {
  ...
  public void testFind_success() {
    LafOlCacheData testResult = serviceMock.find(records[0].getCid());
