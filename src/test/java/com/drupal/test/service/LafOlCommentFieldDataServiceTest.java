...
public class LafOlCommentFieldDataServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals commentType ", records[0].getCommentType(), testResult.getCommentType());
    ...
    org.junit.Assert.assertTrue("expect equals pid ", records[0].getPid() == testResult.getPid());
    org.junit.Assert.assertTrue(
