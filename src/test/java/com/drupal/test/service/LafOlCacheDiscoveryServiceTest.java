...
public class LafOlCacheDiscoveryServiceTest {
  private static DefaultLafOlCacheDiscoveryService serviceMock;
  private static LafOlCacheDiscovery[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlCacheDiscoveryService.class);
    String inputFile = "LafOlCacheDiscovery.json";
    try {
  ...
  public void testFind_success() {
    LafOlCacheDiscovery testResult = serviceMock.find(records[0].getCid());
