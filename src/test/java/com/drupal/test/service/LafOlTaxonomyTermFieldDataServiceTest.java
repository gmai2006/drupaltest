...
public class LafOlTaxonomyTermFieldDataServiceTest {
  private static DefaultLafOlTaxonomyTermFieldDataService serviceMock;
  private static LafOlTaxonomyTermFieldData[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlTaxonomyTermFieldDataService.class);
    String inputFile = "LafOlTaxonomyTermFieldData.json";
    try {
    ...
    final LafOlTaxonomyTermFieldDataId id =
        new LafOlTaxonomyTermFieldDataId(records[0].getLangcode(), records[0].getTid());
  ...
  public void testFind_success() {
    final LafOlTaxonomyTermFieldDataId id =
        new LafOlTaxonomyTermFieldDataId(records[0].getLangcode(), records[0].getTid());
    LafOlTaxonomyTermFieldData testResult = serviceMock.find(id);
    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertTrue(
        "expect equals revisionId ", records[0].getRevisionId() == testResult.getRevisionId());
    org.junit.Assert.assertEquals("expect equals vid ", records[0].getVid(), testResult.getVid());
    org.junit.Assert.assertTrue(
