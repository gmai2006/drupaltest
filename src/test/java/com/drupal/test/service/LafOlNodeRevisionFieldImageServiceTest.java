...
public class LafOlNodeRevisionFieldImageServiceTest {
    private static DefaultLafOlNodeRevisionFieldImageService serviceMock;
    private static LafOlNodeRevisionFieldImage[] records;
    static Gson gson =
            new GsonBuilder()
    ...
    public static void setUp() {
        serviceMock = mock(DefaultLafOlNodeRevisionFieldImageService.class);
        String inputFile = "LafOlNodeRevisionFieldImage.json";
        try {
            String json =
    ...
    public void testFind_success() {
        final LafOlNodeRevisionFieldImageId id =
                new LafOlNodeRevisionFieldImageId(
                        ...
                        records[0].getEntityId(),
                        records[0].getRevisionId());
        LafOlNodeRevisionFieldImage testResult = serviceMock.find(id);
