...
public class LafOlCachePageServiceTest {
  private static DefaultLafOlCachePageService serviceMock;
  private static LafOlCachePage[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlCachePageService.class);
    String inputFile = "LafOlCachePage.json";
    try {
  ...
  public void testFind_success() {
    LafOlCachePage testResult = serviceMock.find(records[0].getCid());
