...
public class LafOlCacheBootstrapServiceTest {
  private static DefaultLafOlCacheBootstrapService serviceMock;
  private static LafOlCacheBootstrap[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlCacheBootstrapService.class);
    String inputFile = "LafOlCacheBootstrap.json";
    try {
  ...
  public void testFind_success() {
    LafOlCacheBootstrap testResult = serviceMock.find(records[0].getCid());
