...
public class LafOlNodeCommentServiceTest {
  private static DefaultLafOlNodeCommentService serviceMock;
  private static LafOlNodeComment[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultLafOlNodeCommentService.class);
    String inputFile = "LafOlNodeComment.json";
    try {
  ...
  public void testFind_success() {
    final LafOlNodeCommentId id =
        new LafOlNodeCommentId(
            ...
            records[0].getDelta(),
            records[0].getEntityId());
    LafOlNodeComment testResult = serviceMock.find(id);
