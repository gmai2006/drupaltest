...
// @Stateless
@Named("LafOlCacheConfigHandler")
public class LafOlCacheConfigHandler extends DelimiterFileHandler<LafOlCacheConfig> {

    @Inject
    @Named("DefaultJpaDao")
    public LafOlCacheConfigHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected LafOlCacheConfig parseLine(List<String> headers, List<String> tokens) {
        LafOlCacheConfig record = new LafOlCacheConfig();
