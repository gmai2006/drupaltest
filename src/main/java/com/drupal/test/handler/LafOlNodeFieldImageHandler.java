...
// @Stateless
@Named("LafOlNodeFieldImageHandler")
public class LafOlNodeFieldImageHandler extends DelimiterFileHandler<LafOlNodeFieldImage> {

    @Inject
    @Named("DefaultJpaDao")
    public LafOlNodeFieldImageHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected LafOlNodeFieldImage parseLine(List<String> headers, List<String> tokens) {
        LafOlNodeFieldImage record = new LafOlNodeFieldImage();
