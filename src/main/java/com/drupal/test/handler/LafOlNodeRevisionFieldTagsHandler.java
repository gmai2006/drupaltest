...
// @Stateless
@Named("LafOlNodeRevisionFieldTagsHandler")
public class LafOlNodeRevisionFieldTagsHandler
        extends DelimiterFileHandler<LafOlNodeRevisionFieldTags> {

    @Inject
    @Named("DefaultJpaDao")
    public LafOlNodeRevisionFieldTagsHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected LafOlNodeRevisionFieldTags parseLine(List<String> headers, List<String> tokens) {
        LafOlNodeRevisionFieldTags record = new LafOlNodeRevisionFieldTags();
