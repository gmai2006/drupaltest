...
// @Stateless
@Named("LafOlCacheBootstrapHandler")
public class LafOlCacheBootstrapHandler extends DelimiterFileHandler<LafOlCacheBootstrap> {

    @Inject
    @Named("DefaultJpaDao")
    public LafOlCacheBootstrapHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected LafOlCacheBootstrap parseLine(List<String> headers, List<String> tokens) {
        LafOlCacheBootstrap record = new LafOlCacheBootstrap();
