...
// @Stateless
@Named("LafOlCacheDiscoveryHandler")
public class LafOlCacheDiscoveryHandler extends DelimiterFileHandler<LafOlCacheDiscovery> {

    @Inject
    @Named("DefaultJpaDao")
    public LafOlCacheDiscoveryHandler(final JpaDao dao) {
        super(dao);
    }

    @Override
    protected LafOlCacheDiscovery parseLine(List<String> headers, List<String> tokens) {
        LafOlCacheDiscovery record = new LafOlCacheDiscovery();
