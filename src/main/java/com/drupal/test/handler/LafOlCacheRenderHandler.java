...
// @Stateless
@Named("LafOlCacheRenderHandler")
public class LafOlCacheRenderHandler extends DelimiterFileHandler<LafOlCacheRender> {

  @Inject
  @Named("DefaultJpaDao")
  public LafOlCacheRenderHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected LafOlCacheRender parseLine(List<String> headers, List<String> tokens) {
    LafOlCacheRender record = new LafOlCacheRender();
