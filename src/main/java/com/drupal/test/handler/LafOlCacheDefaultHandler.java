...
// @Stateless
@Named("LafOlCacheDefaultHandler")
public class LafOlCacheDefaultHandler extends DelimiterFileHandler<LafOlCacheDefault> {

  @Inject
  @Named("DefaultJpaDao")
  public LafOlCacheDefaultHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected LafOlCacheDefault parseLine(List<String> headers, List<String> tokens) {
    LafOlCacheDefault record = new LafOlCacheDefault();
