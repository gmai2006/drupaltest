...
// @Stateless
@Named("LafOlCachePageHandler")
public class LafOlCachePageHandler extends DelimiterFileHandler<LafOlCachePage> {

  @Inject
  @Named("DefaultJpaDao")
  public LafOlCachePageHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected LafOlCachePage parseLine(List<String> headers, List<String> tokens) {
    LafOlCachePage record = new LafOlCachePage();
