...
@Entity
@Table(name = "lafol_cache_menu")
public class LafOlCacheMenu implements Serializable {
    private static final long serialVersionUID = 163445265016369172L;
