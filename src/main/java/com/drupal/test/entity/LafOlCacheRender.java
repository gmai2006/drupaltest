...
@Entity
@Table(name = "lafol_cache_render")
public class LafOlCacheRender implements Serializable {
    private static final long serialVersionUID = 163445265018948015L;
