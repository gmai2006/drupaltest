...
@Entity
@Table(name = "lafol_cache_bootstrap")
public class LafOlCacheBootstrap implements Serializable {
    private static final long serialVersionUID = 163445265007237846L;
