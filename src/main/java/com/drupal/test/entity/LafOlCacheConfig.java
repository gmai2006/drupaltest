...
@Entity
@Table(name = "lafol_cache_config")
public class LafOlCacheConfig implements Serializable {
  private static final long serialVersionUID = 166875433007288806L;
