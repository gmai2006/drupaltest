...
@Entity
@IdClass(LafOlNodeRevisionBodyId.class)
@Table(name = "lafol_node_revision__body")
public class LafOlNodeRevisionBody implements Serializable {
    private static final long serialVersionUID = 163445265070449423L;
