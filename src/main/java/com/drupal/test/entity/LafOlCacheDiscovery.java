...
@Entity
@Table(name = "lafol_cache_discovery")
public class LafOlCacheDiscovery implements Serializable {
  private static final long serialVersionUID = 166875433009436316L;
