...
@Entity
@Table(name = "lafol_cache_default")
public class LafOlCacheDefault implements Serializable {
  private static final long serialVersionUID = 166875433008956748L;
