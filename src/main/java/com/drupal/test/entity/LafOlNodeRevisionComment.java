...
@Entity
@IdClass(LafOlNodeRevisionCommentId.class)
@Table(name = "lafol_node_revision__comment")
public class LafOlNodeRevisionComment implements Serializable {
  private static final long serialVersionUID = 166875433044855019L;
  ...
  /** Description: comment_status. */
  @javax.validation.constraints.NotNull
  @Basic
  @Column(name = "comment_status")
  private java.lang.Integer commentStatus;

  public LafOlNodeRevisionComment() {}
