...
@Entity
@IdClass(LafOlNodeFieldTagsId.class)
@Table(name = "lafol_node__field_tags")
public class LafOlNodeFieldTags implements Serializable {
    private static final long serialVersionUID = 163445265060114457L;
