...
@Entity
@Table(name = "lafol_cache_entity")
public class LafOlCacheEntity implements Serializable {
  private static final long serialVersionUID = 166875433010451272L;
