...
@Entity
@Table(name = "lafol_cache_page")
public class LafOlCachePage implements Serializable {
  private static final long serialVersionUID = 166875433011542981L;
