...
@Entity
@IdClass(LafOlNodeCommentId.class)
@Table(name = "lafol_node__comment")
public class LafOlNodeComment implements Serializable {
    private static final long serialVersionUID = 163445265056010311L;
