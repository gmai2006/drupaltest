...
@Entity
@IdClass(LafOlBlockContentRevisionBodyId.class)
@Table(name = "lafol_block_content_revision__body")
public class LafOlBlockContentRevisionBody implements Serializable {
  private static final long serialVersionUID = 166875433006064991L;
  ...
  public LafOlBlockContentRevisionBody() {}
