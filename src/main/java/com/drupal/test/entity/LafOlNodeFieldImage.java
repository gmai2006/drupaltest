...
@Entity
@IdClass(LafOlNodeFieldImageId.class)
@Table(name = "lafol_node__field_image")
public class LafOlNodeFieldImage implements Serializable {
  private static final long serialVersionUID = 166875433036773445L;
