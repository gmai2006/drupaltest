...
@Entity
@Table(name = "lafol_cache_data")
public class LafOlCacheData implements Serializable {
    private static final long serialVersionUID = 163445265011567428L;
