...
@Entity
@IdClass(LafOlBlockContentBodyId.class)
@Table(name = "lafol_block_content__body")
public class LafOlBlockContentBody implements Serializable {
  private static final long serialVersionUID = 166875433001571996L;
